    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(blank=True, help_text='Phone number for OTP verification (optional)', max_length=15, null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('purpose', models.CharField(choices=[('password_reset', 'Password Reset'), ('phone_verification', 'Phone Verification'), ('login_verification', 'Login Verification'), ('registration', 'Registration Verification')], default='password_reset', max_length=20)),
