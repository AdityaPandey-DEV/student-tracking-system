    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'unique_together': {('day_of_week', 'time_slot', 'course', 'year', 'section', 'academic_year', 'semester'), ('day_of_week', 'time_slot', 'room', 'academic_year', 'semester'), ('day_of_week', 'time_slot', 'teacher', 'academic_year', 'semester')},
            },
        ),
        migrations.CreateModel(
            name='TeacherSubject',
